...
APP_VERSION = "15.1.2"
BUILD_TAG = "MINIAPP-RECOVERY-PERSIAN-NEWS-FUTURE-GOLD"
...
CACHE_PERSISTENT_STALE_MAX_SECONDS = int(os.environ.get("CACHE_PERSISTENT_STALE_MAX_SECONDS", "604800"))
    ...
    def do_POST(self):
        ...
        try:
            ...
            if uid is None:
                ...
                if market is None:
                    # Even with a cold provider cache, _mini_overview_payload can recover
                    # from SQLite price history and global computed fallbacks.
