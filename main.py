...
APP_VERSION = "15.4.0"
BUILD_TAG = "GO-IDEMPOTENT-NEWSTAB-FIX-ASSETPAGE-BUBBLE-AMOUNT"
...
def build_opportunity_scanner(market):
    ...
    lines=["🎯 <b>تصمیم‌یار فرصت‌های بازار</b>", "طلایار بر اساس روند، مومنتوم، کیفیت داده و شرایط ریسک، وضعیت اقدام را مشخص می‌کند.", ""]
    for rank,(_,asset,f) in enumerate(candidates[:7],1):
        ...
        action="🟢 بررسی خرید پله‌ای" if score>=65 else ("🔴 احتیاط/کاهش ریسک" if score<=35 else "🟡 صبر و بررسی")
