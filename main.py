...
# -*- coding: utf-8 -*-
"""
طلایار v14.2.0 Production Stability + Signal Engine — دستیار هوشمند بازار طلا، ارز و کریپتو
نسخهٔ فروش حرفه‌ای:
...
APP_VERSION = "14.2.0"
BUILD_TAG = "PRODUCTION-STABILITY-PERSISTENCE-CHART-GAPS"
    ...
    if data.startswith("admin:"):
        ...
        if action == "database":
            try:
                ...
                text = (
                    "🗄 <b>وضعیت دیتابیس</b>\n\n"
                    f"Persistence: <b>{persistence_badge}</b>\n"
                    f"DB Path: <code>{html.escape(st['db_path'])}</code>\n"
                    f"Volume /data: <b>{'✅' if st['mounted'] else '❌'}</b> | Writable: <b>{'✅' if st['writable'] else '❌'}</b>\n"
                    f"SQLite: <b>{html.escape(str(quick))}</b> | حجم: <b>{size_mb:.2f} MB</b>\n"
                    ...
                    f"آخرین بکاپ: <b>{html.escape(last_backup)}</b>\n"
